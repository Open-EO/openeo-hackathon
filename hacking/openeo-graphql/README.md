...
> __Note:__ This project utilizes a [fork](https://github.com/mklan/openeo-js-client) of [openeo-js-client](https://github.com/Open-EO/openeo-js-client) with a minimal change to enable usage in nodejs
...
> __Hint:__ open the links using your middle mouse key, github still haven't implemented the open in new tab feature for links)
...
> __Note:__ currently the download of the result is not working!
